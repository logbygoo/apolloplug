...
export const LOCATIONS: Location[] = [
  { lat: 52.1755, lng: 20.9427, type: 'supercharger', title: 'Supercharger', address: 'Aleja Krakowska 61, Warszawa', price: null },
  { lat: 52.2272, lng: 20.9023, type: 'greenway', title: 'Greenway', address: 'Batalionów Chłopskich 73, Warszawa', price: null },
  { lat: 52.2280, lng: 21.0035, type: 'pickup_point', title: 'Warszawa Centralna', address: 'Aleje Jerozolimskie 54, Warszawa', price: 149 },
  { lat: 52.2968, lng: 21.1189, type: 'supercharger', title: 'Supercharger', address: 'Radzymińska 334, Ząbki', price: 190 },
