...
const locations: Location[] = [
  ...
  { lat: 52.2330, lng: 20.9818, type: 'building_company', title: 'main office apolloplug.com', address: 'Grzybowska 86, Warszawa', price: 0 },
];
      ...
      <div className="container mx-auto max-w-4xl px-4 md:px-6 pb-16 md:pb-24 space-y-16">
        <div className="text-center">
            <div className="flex justify-center items-center gap-4">
                <PhoneIcon className="w-12 h-12 md:w-16 md:h-16 text-primary animate-ring" />
                <a href="tel:500308400" className="text-4xl md:text-6xl font-bold tracking-tight text-foreground hover:text-primary transition-colors">
                    500 308 400
                </a>
            </div>
