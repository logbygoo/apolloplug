...
export const BoltIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path fillRule="evenodd" d="M11.25 2.25c.414 0 .75.336.75.75v8.25a.75.75 0 001.5 0V3a.75.75 0 00-.75-.75h-1.5z" clipRule="evenodd" />
    <path d="M11.25 2.25c-.414 0-.75.336-.75.75v8.25a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75h1.5z" />
    <path fillRule="evenodd" d="M12 21.75c5.385 0 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25 2.25 6.615 2.25 12s4.365 9.75 9.75 9.75zM12 3.75a8.25 8.25 0 100 16.5 8.25 8.25 0 000-16.5z" clipRule="evenodd" />
    <path d="M12 3.75a8.25 8.25 0 018.25 8.25H3.75A8.25 8.25 0 0112 3.75z" />
    <path d="M13.23 8.705a.75.75 0 00-1.06 1.06l3 3a.75.75 0 101.06-1.06l-3-3z" />
    <path d="M12.17 12.765a.75.75 0 00-1.06-1.06l-3 3a.75.75 0 001.06 1.06l3-3z" />
    <path fillRule="evenodd" d="M11.25 2.25c.414 0 .75.336.75.75v8.25a.75.75 0 001.5 0V3a.75.75 0 00-.75-.75h-1.5z" clipRule="evenodd" />
    <path d="M11.25 2.25c-.414 0-.75.336-.75.75v8.25a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75h1.5z" />
    <path fillRule="evenodd" d="M12.969 8.28a.75.75 0 010 1.06l-3 3a.75.75 0 01-1.06-1.06l3-3a.75.75 0 011.06 0z" clipRule="evenodd" />
    <path d="M12.969 8.28a.75.75 0 000 1.06l-3 3a.75.75 0 001.06 1.06l3-3a.75.75 0 00-1.06-1.06z" />
    <path fillRule="evenodd" d="M10.78 11.47a.75.75 0 01-1.06 0l-3-3a.75.75 0 111.06-1.06l3 3a.75.75 0 010 1.06z" clipRule="evenodd" />
    <path d="M10.78 11.47a.75.75 0 00-1.06 0l-3-3a.75.75 0 00-1.06 1.06l3 3a.75.75 0 001.06 0z" />
  </svg>
);
