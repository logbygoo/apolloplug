...
export const TermsOfServiceContent = (
  <div style={{ padding: '40px', fontFamily: 'Arial, sans-serif' }}>
    <h1 className="text-2xl font-bold mb-4">Regulamin Serwisu ApolloPlug.com</h1>
    <p><strong>Data wejścia w życie: 01.03.2025</strong></p>
    
    <h2 className="text-xl font-bold mt-6 mb-2">§1. Postanowienia ogólne</h2>
    ...
    <h2 className="text-xl font-bold mt-6 mb-2">§2. Rezerwacje</h2>
    ...
    <h2 className="text-xl font-bold mt-6 mb-2">§3. Płatności</h2>
    ...
    <h2 className="text-xl font-bold mt-6 mb-2">§4. Ochrona danych osobowych</h2>
    ...
    <h2 className="text-xl font-bold mt-6 mb-2">§5. Postanowienia końcowe</h2>
