...
export const HERO_CARS: HeroCar[] = [
  ...
  {
    id: '2',
    name: 'Wypożycz z rabatem -15%',
    imageUrl: 'https://img.apolloidea.com/tesla-y/14.jpg',
    subtitle: 'Otrzymaj kod rabatowy za zapisanie się do Klubu Apollo',
    secondaryBtnText: 'Promocje i Kody Rabatowe',
    secondaryBtnLink: '/promocje',
    theme: 'dark',
  },
  {
    id: '3',
